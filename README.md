...
├── requirements.txt        # Dependencies (Qiskit, OR-Tools, Pandas, etc.)
│
├── data/                   # Data Management
│   ├── raw/                # Synthetic TSP instances (N=5, 6, 7 cities) 
│   └── processed/          # Pre-processed data or matrix formats
│
├── src/                    # Source Code
│   ├── __init__.py
│   ├── common/             # Shared Utilities
│   │   ├── tsp_generator.py    # Synthetic data generator (Reproducible seeds)
│   │   └── utils.py            # Visualization & calculation tools
│   │
...
│   │   └── or_tools_solver.py  # Google OR-Tools integration
│   │
...
│   ├── 02_classical_benchmark.ipynb # Experiments: GA, SA, OR-Tools
│   ├── 03_quantum_simulation.ipynb  # Experiments: QAOA Prototyping
...
└── reports/                # Documentation & Outputs
    ...
    └── final_report/       # TÜBİTAK final report drafts
```
##  Installation
...
git clone git clone [https://github.com/senademirbas/Quantum-Logistics-Optimization.git]([https://github.com/YOUR_USERNAME/Tubitak-Quantum-Logistics-Optimization.git](https://github.com/senademirbas/Quantum-Logistics-Optimization.git))
